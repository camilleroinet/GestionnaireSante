package com.example.gestionnairesante.ui.poids.adapter
...
class AdapterRecyclerPoids(private val clickListener: (PoidsInner) -> Unit) : RecyclerView.Adapter<AdapterRecyclerPoids.MyViewHolder>() {
