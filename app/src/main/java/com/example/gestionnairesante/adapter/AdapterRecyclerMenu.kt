...
class AdapterRecyclerMenu (private val clickListener: (MenuData) -> Unit) : RecyclerView.Adapter<AdapterRecyclerMenu.MyViewHolder>(){
    ...
    class MyViewHolder(val binding: RepasCardviewMenuBinding): RecyclerView.ViewHolder(binding.root){
